...
const UserPaymentHistory = () => {
    ...
    const fetchRechargeData = async (referenceId) => {
        try {
            const response = await axios.get(`https://colortredo-production.up.railway.app/userGame/getRecharge?referanceId=${referenceId}`);
    ...
    const fetchWithdrawData = async (referenceId) => {
        try {
            const response = await axios.get(`https://colortredo-production.up.railway.app/userGame/getWithdraw?referanceId=${referenceId}`);
            if (response.data && response.data.message === "success") {
